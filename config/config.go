...
func Load() Config {
	...
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefault("POSTGRES_DATABASE", "uzunnn"))
	...
	cfg.ServiceName = cast.ToString(getOrReturnDefault("SERVICE_NAME", "task_backend"))
